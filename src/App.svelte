...
<div class="wrapper">
	<main class="wrapper__content block-content {settingsEditor.theme}">
		...
		{/if}
		<WorkingArea canvas={settingsEditor.canvas} onChangeCanvas={onChangeCanvas} onChangeTool={onChangeTool} onUpdatePanelPosition={handlerUpdatePanelPosition} onUpdatePanelStatus={handlerUpdatePanelStatus} layersPanel={settingsEditor.layersPanel} toolsPanel={settingsEditor.toolsPanel} />
		<Footer />
	</main>
</div>
