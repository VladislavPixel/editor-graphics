	...
	changeTypeModal(newType: ModalTypes): void {
		switch (newType) {
			...
			case "action-size-canvas":
				...
				this.offer = "Задавать ширину и высоту нужно в пикселях, исходите из этого расчета. Дефолтные размеры установлены в значениях: ширина - 700px, высота - 500px. Значения ширины и высоты применяются ко всем слоям. В инпуты указывайте только числа. Если вы не зададите какое-то значение или зададите, но некорректно, оно возьмется из дефолта.";
				break;
